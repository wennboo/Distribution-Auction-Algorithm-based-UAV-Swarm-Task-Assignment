...
plt.plot(x_scaleall,y_timeall, linewidth=1,c='red',label="all")
#plt.plot(x_scaleline,y_timeline, linewidth=1,c='yellow',label='line')
plt.plot(x_scalerandom,y_timerandom, linewidth=1,c='blue',label='random')
plt.plot(x_scaleall,y_timegrouplimit, linewidth=1,c='black',label="Shared Memory")
plt.legend()
